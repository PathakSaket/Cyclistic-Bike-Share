...
## Introduction
In this case study, I will perform many real-world tasks of a junior data analyst at a fictional company, Cyclistic. In order to answer the key business questions, I will follow the steps of the data analysis process: __[Ask](https://github.com/PathakSaket/Cyclistic-Bike-Share?tab=readme-ov-file#ask), [Prepare](https://github.com/PathakSaket/Cyclistic-Bike-Share?tab=readme-ov-file#prepare), [Process](https://github.com/PathakSaket/Cyclistic-Bike-Share?tab=readme-ov-file#process), [Analyze](https://github.com/PathakSaket/Cyclistic-Bike-Share?tab=readme-ov-file#analyze-and-share), [Share](https://github.com/PathakSaket/Cyclistic-Bike-Share?tab=readme-ov-file#analyze-and-share), and [Act](https://github.com/PathakSaket/Cyclistic-Bike-Share?tab=readme-ov-file#act)__.
